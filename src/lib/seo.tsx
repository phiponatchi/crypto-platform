...
// See https://docs.ilaunch.app/features/seo
...
/*     metadataBase: new URL(
    ...
    openGraph: {
      ...
      siteName: (openGraph?.title == "string" ? openGraph?.title : openGraph?.title?.toString()) || config.appName,
